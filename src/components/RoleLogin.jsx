    ...
    <div className="login-container">
      <div className="login-card">
        <div className="login-left">
          <div className="logo">
            <img src="https://img.icons8.com/ios-filled/50/ffffff/graduation-cap.png" alt="CloudCampus" />
            <h1>CloudCampus</h1>
          </div>
          <div className="secure-login-pill">Secure Login Portal</div>
          <h2>Welcome back</h2>
          <p>Sign in to access your personalized CloudCampus dashboard. Students can use Roll ID or Email. Faculty and Admin use Email.</p>
        </div>
